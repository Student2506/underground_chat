...
class ReadConnectionStateChanged(Enum):
    INITIATED = 'устанавлваем соединение'
...
async def update_conversation_history(panel, message_queue):
    while True:
        ...
        # TODO сделать промотку умной, чтобы не мешала просматривать историю
        # ScorlledText.frame
        # ScorlledText.vbar
        panel.yview(tk.END)
